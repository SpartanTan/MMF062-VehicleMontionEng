...
totalSprungMass =totalMass-totalUnsprungMass;         %ADD YOUR CODE HERE;
...
roadSeverity =   10*10^-6;         %ADD YOUR CODE HERE;
vehicleVelocity =  80/3.6;       %ADD YOUR CODE HERE;
roadWaviness =  2.5;          %ADD YOUR CODE HERE;
...
% %
roadSeveritySmooth =   1*10^(-6);   %ADD YOUR CODE HERE;
roadSeverityRough =   10*10^(-6);    %ADD YOUR CODE HERE;
roadSeverityVeryRough = 100*10^(-6);   %ADD YOUR CODE HERE;
...
vehicleVelocityVeryRough = 8/3.6;
