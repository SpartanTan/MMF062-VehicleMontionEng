...
for m = 1 : length(angularFrequencyVector)
    psdAcceleration(m,:) = abs(transferFunctionFrontZrToRide(m))^2*roadSpectrum(m);%ADD YOUR CODE HERE
...
plot(frontWheelSuspStiffVector,frontWheelSuspDampVector(iOptimalRmsForce)); %ADD YOUR CODE HERE
