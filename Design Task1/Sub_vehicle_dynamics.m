...
omegaDotr = -(Fair*R^2*f_r - Fair*R^2*mu_r - Fair*R*f_r*h + Fair*R*h*mu_r + L_r*M*R*f_r*g*cos(theta) + L_f*M*R*g*mu_r*cos(theta))/(J*(L_f + L_r)); %[rad/s/s] rotational acceleration, rear
