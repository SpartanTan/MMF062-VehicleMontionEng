...
vehicleData.brakeDemand     = 6000.0;                              % Brake force demand
SWA                         = 10;                           % Steering wheel angle                                        
vehicleData.pRollDist       = 0.25;  %default 0.65          % Front/Total roll stiffness distribution
vehicleData.brakeDist       = 0.81;                              % Front/Total brake distribution ratio
% end of file